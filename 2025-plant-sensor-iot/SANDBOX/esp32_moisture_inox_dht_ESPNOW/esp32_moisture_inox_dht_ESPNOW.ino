...
#define TIME_TO_SLEEP 300  // Time in seconds before ESP32 wakes up from deep sleep
...
// Increment boot count and print it
  ...
  */
  ...
  esp_sleep_enable_timer_wakeup(TIME_TO_SLEEP * uS_TO_S_FACTOR);  // Convert seconds to microseconds
