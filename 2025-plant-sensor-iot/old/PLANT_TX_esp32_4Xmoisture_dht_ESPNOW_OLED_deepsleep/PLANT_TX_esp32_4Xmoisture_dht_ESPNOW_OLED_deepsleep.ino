...
*/
  ...
  for (int i = 0; i < numSamples; i++) {
    ...
    // filling circles
    int circleX = 4 + sampleCount * 10;   // startX + i * spacing
    ...
    delay(100);
    display.setCursor(0, 34);
    //display.print("Sample "); display.print(i+1);display.print(" = ");display.print(sample);
    display.display();
...
void updateDisplay() {
  ...
  display.setTextSize(1);
  display.print("1:"); display.print(plantReadings.moisture1);
  display.print(" 2:"); display.print(plantReadings.moisture2);
  display.print(" 3:"); display.print(plantReadings.moisture3);
  display.print(" 4:"); display.print(plantReadings.moisture4);
