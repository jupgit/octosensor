...
void updateDisplay(){
  ...
  display.print("1:"); display.print(incoming_plantMoisture1);
  display.print("2:"); display.print(incoming_plantMoisture2);
  display.print("3:"); display.print(incoming_plantMoisture3);
  display.print("4:"); display.print(incoming_plantMoisture4);
